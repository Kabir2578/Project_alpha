...
const CondidateRegister = () => {
    ...
    const handleImageChange = (event) => {
        ...
        formik.setFieldValue("candidateResume", file); // Update the correct field name
                                    ...
                                    <Grid container spacing={1}>
                                        ...
                                        <Grid item xs={12} sm={6} md={8}>
                                            <Button variant='outlined' component="label" fullWidth >
                                                Upload Resume
                                                <input hidden accept="application/pdf" type="file" name="candidateResume" onChange={handleImageChange} />
                                            </Button>
                                            {cImage && (
