    ...
    return (
        <>
            <Box sx={{ px: { md: spacing(17), xs: 2 }, background: palette.secondary.deem }}>
                <Typography variant='body2' sx={{ py: 1, }}><Typography component={'span'}>IMPORTANT :</Typography> SmartJobs doesn't solicit money from jobseekers. If someone calls citing SmartJobs name and asks for money then pls report to smartjob@corporate.in <Link to="froud">Know more</Link></Typography>
            </Box>
            <Box
                sx={{
                    ...
                    height: { lg: '45vh', md: '45vh', xs: '100%' },
                    position: 'relative',
                }}
            >
                <Box sx={{ px: { md: spacing(17), xs: 2 }, height: '100%', background: palette.primary.main, py: 2 }}>
                    <Grid container spacing={3} justifyContent="space-between">
                        <Grid item xs={12} md={2}>
                            <Stack sx={{ my: 1, width: { md: '200px', xs: '100%' } }}>
                                ...
                                <Typography variant="body2" sx={{ color: '#bdbdbd', pr: 1 }}>
                                    ...
                                    <Box key={index} sx={{ display: 'flex', alignItems: 'center', gap: 1, }}>
                                        ...
                                        <Stack>
                                            ...
                                            <Typography variant="body2">
                                                <Link
                                                    to={info.link}
                                                    style={{ color: '#fdfdfd', textDecoration: 'none', display: 'flex', alignItems: 'center' }}
                                                >
                                                    {info.content}
                                                </Link>
                                            </Typography>
                        ...
                        <Grid item xs={12} md={3}>
                            <Box sx={{ my: 1 }}>
                                ...
                                <Divider sx={{ backgroundColor: '#fff', my: 1 }} />
                                <Typography variant="body2" sx={{ color: '#bdbdbd', my: 1 }}>
                    ...
                    <Typography variant="body2" textAlign="center" sx={{ color: '#FDFDFD' }}>
                        © 2024 SmartJob. All rights reserved | Designed by Amit Kumar
                    </Typography>
                </Box>
            </Box>
        </>
